...
<div class="box box-default productos_vendidos">
	
	<div class="box-header with-border">
  
      <h3 class="box-title"><b>PRODUCTOS MÁS COMPRADOS</b></h3>

    </div>

	<div class="box-body body_vendidos">
    ...
    <div class="box-footer no-padding footer_vendidos">
    	
		<ul class="nav nav-pills nav-stacked">
			
			 <?php
            if($totalCompras["total"] == 0){
              $total = 1;
            }
            else{
              $total = $totalCompras["total"];
            }

            if(count($productos)<5){
              $limiteMostrar = count($productos);
            }else{
              $limiteMostrar = 5;
            }
          	for($i = 0; $i <$limiteMostrar ; $i++){
          		...
          		echo '<li>
						 ...
						 '.ceil($productos[$i]["compras"]*100/$total).'%
						 </span>
