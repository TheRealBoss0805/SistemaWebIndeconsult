...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><b>ADMINISTRAR USUARIOS</b></li>
       ...
       foreach ($usuarios as $key => $value){
          ...
          echo ' <tr>
                  ...
                  if($_SESSION['id'] != $value['id_usuario']){
                      ...
                      echo '<button class="btn btn-danger btnEliminarUsuario" idUsuario="'.$value["id_usuario"].'" fotoUsuario="'.$value["foto"].'" usuario="'.$value["usuario"].'"><i class="fa fa-times"></i></button>';
                  }
                    echo '</div>  
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA EL USUARIO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa icon-emo-sunglasses"></i></span> 
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <p class="help-block">¡Tamaño máximo de la foto 2MB!</p>
