...
class ModeloProductos{
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria,id_usuario, codigo, descripcion, imagen, stock, compras) VALUES (:id_categoria,:id_usuario, :codigo, :descripcion, :imagen, 0, 0)");
