          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoCliente" placeholder="Razón Social" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input minlength="0" maxlength="11" class="form-control input-lg" name="nuevoDocumentoId" placeholder="Ingresar RUC" required>
